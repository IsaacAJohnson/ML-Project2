...
bank4 <- bank1 %>% 
  mutate(married40highbal = ifelse(Customer_Age > 40 & married == 1 & Total_Revolving_Bal > 1000, 1, 0)) %>%
    mutate(highcreditBlue = ifelse(Credit_Limit>10000 & Avg_Open_To_Buy>1000 & blue == 1, 1, 0)) %>%
